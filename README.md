...
ppte simulate --ref chr21_tiny.fa --bed real.bed --num 2 --pool MEI.fa --diverse
```
...
- `diverse` : Introduce sequence diversity among individuals for the same TE event (Suitable for evaluating methods that require a TE panel as input)
